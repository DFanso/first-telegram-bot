...
if (!process.env.QBITTORRENT_NETWORK_PATH) {
  throw new Error('QBITTORRENT_NETWORK_PATH is not defined');
}
...
export const config: BotConfig = {
  ...
  QBITTORRENT_NETWORK_PATH: process.env.QBITTORRENT_NETWORK_PATH as string
}; 